...
const SoundSystem = (() => {
  ...
  const profiles = {
    ...
    heaven: {
      ...
      navigate:   { type: 'sine', freqs: [1319, 1568], dur: 0.12, gain: 0.03 },
      modal_open: { type: 'sine', freqs: [1568, 2093], dur: 0.18, gain: 0.04 },
      modal_close:{ type: 'sine', freqs: [1568, 1047], dur: 0.12, gain: 0.03 },
      toggle:     { type: 'sine', freqs: [1319, 1568], dur: 0.1, gain: 0.03 },
      success:    { type: 'sine', freqs: [1568, 2093, 2637], dur: 0.25, gain: 0.05 },
      delete_snd: { type: 'sine', freqs: [1174, 880], dur: 0.15, gain: 0.04 },
